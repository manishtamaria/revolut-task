...
import com.revolut.model.BaseDbModel;
...
public class DbUtils {
    ...
    public <E> QueryResult<E> executeQuery(String query, QueryExecutor<E> queryExecutor) {
        ...
        try {
            con = InMemDataSource.getConnection();
            ...
            throw new RevolutDbException(th);
        } finally {
     ...
     */
    public static class CreationQueryExecutor<T extends BaseDbModel> implements QueryExecutor<T> {
        private T object;
